...
{{--                 <nav class="category" >--}}
{{--                     <button class="navbar-toggler d-sm-block d-md-none" type="button" data-bs-toggle="collapse" data-bs-target="#navCategory" aria-expanded="false" aria-controls="#navCategory" aria-label="Toggle Category">☰</button>--}}
{{--                     <div class="collapse navbar-collapse" id="navCategory">--}}
{{--                         <div class="category-text"> Categories </div>--}}
{{--                         <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>--}}
{{--                         <ul class="navbar-nav">--}}
{{--                             <li><a href="#" class="category_btn1"> <span>กล่อง</span> <i class="bi bi-chevron-down first"></i></a>--}}
{{--                                 <ul class="category_btn1_show ">--}}
{{--                                     <li><a href="#"><span>กล่องเล็ก</span></a></li>--}}
{{--                                     <li><a href="#"><span>กล่องกลาง</span></a></li>--}}
{{--                                     <li><a href="#"><span>กล่องใหญ่</span></a></li>--}}
{{--                                 </ul>--}}
{{--                             </li>--}}
{{--                             <li><a href="#"class="category_btn2"> <span>ถาด</span> <i class="bi bi-chevron-down second"></i></a>--}}
{{--                                 <ul class="category_btn2_show">--}}
{{--                                     <li><a href="#"><span>ถาดหลุมอลูมิเนียม</span></a></li>--}}
{{--                                     <li><a href="#"><span>ถาดเทฟล่อน</span></a></li>--}}
{{--                                 </ul>--}}
{{--                             </li>--}}
{{--                             <li><a href="#"class="category_btn3"> <span>แม่พิมพ์</span> <i class="bi bi-chevron-down third"></i></a>--}}
{{--                                 <ul class="category_btn3_show">--}}
